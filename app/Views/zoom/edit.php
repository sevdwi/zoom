    ...
    <div class="container">
        <div class="card shadow mx-auto" style="max-width: 700px;">
            <div class="card-body">
                ...
                <form action="<?= base_url('/zoom/update/' . $zoom['id']) ?>" method="post">

                    <div class="mb-3">
                        <label class="form-label">Kegiatan</label>
                        <input type="text" name="kegiatan" class="form-control" value="<?= $zoom['kegiatan'] ?>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" name="jam_mulai" class="form-control" value="<?= $zoom['jam_mulai'] ?>" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Link</label>
                        <textarea name="link" class="form-control" required> <?= $zoom['link'] ?></textarea>
                    </div>
